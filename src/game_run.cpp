...
void startMoria(int seed, bool start_new_game) {
    ...
    if (result) {
        ...
        /*
            This is where you can modify some user statistics

            if you want to see all the stats, you can CTRL + CLICK on
            the property you want, if your editor supports Find Reference
        */
        // Max HP
        py.misc.max_hp;
...
static void playerRegenerateHitPoints(int percent) {
    ...
    // Controls the regeneration so that it will always regen to max hp
    // py.misc.current_hp = py.misc.max_hp;
